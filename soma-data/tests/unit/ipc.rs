...
use crate::tempdir;
use somatize_core::{Codec, Packing};
use somatize_core::{Executor, Value, compile};
use somatize_data::{Frame, Ipc, Parquet, Span};
...
fn and_somebody_elses_kind_is_left_exactly_as_it_arrived() {
    ...
    let theirs = somatize_core::written_down("torch.Tensor", vec![1, 2, 3]);
